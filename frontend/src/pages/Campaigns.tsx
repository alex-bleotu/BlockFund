...
import { Calendar, MapPin, Target, Tag, Search, Filter, Rocket, TrendingUp, Users, Clock } from 'lucide-react';
...
export function Campaigns() {
  ...
  const stats = [
    {
      icon: TrendingUp,
      value: campaigns.reduce((acc, curr) => acc + curr.current_amount, 0).toFixed(2),
      label: 'ETH Raised',
      color: 'text-primary'
    },
    {
    ...
    {
      icon: Clock,
      value: campaigns.filter(c => new Date(c.deadline) > new Date()).length,
      label: 'Ending Soon',
      color: 'text-error'
    }
  ];
