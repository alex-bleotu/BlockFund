...
import { Calendar, MapPin, Target, Rocket, Edit, Trash2, AlertCircle, Tag } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-bold text-text mb-2">No Campaigns Yet</h2>
            <p className="text-text-secondary mb-8">
              Start your first campaign and begin your fundraising journey.
            </p>
            <button
              onClick={() => navigate('/fund/new')}
            ...
            {campaigns.map((campaign, index) => (
              ...
              >
                <div className="relative h-48">
                  <img
                    src={campaign.images[0] || 'https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?auto=format&fit=crop&q=80'}
                    alt={campaign.title}
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="flex items-center justify-between text-light">
                      ...
                      <span className={`text-sm px-2 py-1 rounded-full ${
                        campaign.status === 'active' ? 'bg-success/80' : 'bg-error/80'
                      }`}>
                        {campaign.status}
                      </span>
                    </div>
                ...
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <div className="h-2 bg-background-alt rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${calculateProgress(campaign.current_amount, campaign.goal)}%` }}
                      />
                    </div>
                    <div className="flex justify-between items-center mt-2 text-sm">
                      <span className="text-text-secondary">
                        {campaign.current_amount.toFixed(2)} ETH raised
                      </span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      <span>{campaign.goal.toFixed(2)} ETH Goal</span>
                    </button>
