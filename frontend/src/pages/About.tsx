import { Users, Shield, Rocket, Award } from 'lucide-react';
  ...
  const values = [
    {
      ...
      description: 'We prioritize the security of our platform and the trust of our community above all else.',
    },
    {
      icon: Users,
      title: 'Community First',
      description: "Our decisions are guided by what's best for our diverse and growing community.",
    },
    {
      icon: Rocket,
      title: 'Innovation',
      description: "We continuously push the boundaries of what's possible in crowdfunding.",
    },
    {
      icon: Award,
      title: 'Excellence',
        ...
        <div className="relative py-24 sm:py-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
              ...
              making it more transparent, secure, and accessible for everyone.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto">
            To democratize fundraising by leveraging blockchain technology,
            creating a transparent and efficient platform that connects innovators
