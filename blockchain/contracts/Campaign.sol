    ...
    contract Campaign {
        ...
        event CampaignClosed(uint256 indexed campaignId, address indexed creator);
        ...
        function closeCampaign(uint256 _campaignId) external {
            ...
            require(campaignData.status == CampaignStatus.ACTIVE || campaignData.status == CampaignStatus.SUCCESSFUL, "Campaign cannot be closed");
        ...
        function withdraw(uint256 _campaignId) external {
            ...
            require(
                campaignData.status == CampaignStatus.CLOSED || campaignData.status == CampaignStatus.SUCCESSFUL,
